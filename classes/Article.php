...
class Article
{
  ...
  */
   ...
   * @param object $conn Connection to the database
   * 
   * @return boolean True if the update was succesfull, false otherwise
  */
  ...
  */
   ...
   * 
   * @param objcet $conn Connection to the database
   * 
   * @return boolean True if the delete was succesful, false otherwise
   */
   ...
   * @param object $conn Connection to the database
   * 
   * @return boolean True if the insert was succesfull, false otherwise
  */
